...
if ($num_vocab_items) {
	...
	<div class="vocablist">
		...
		if($view == "flashcards") {
			?>
			<div class="fcards">
				<a href="#prev" onclick="fcnav('prev');return false;" class="fcnav fcnav-prev"></a>
				<a href="#next" onclick="fcnav('next');return false;" class="fcnav fcnav-next"></a>
				<div class="fcards-container">
					<div class="fcard">
